...
public class VentasForm extends javax.swing.JInternalFrame {
    ...
    public VentasForm() {
        ...
        generarSerie();
        fecha();
        txtVendedor.setText("Jesus Guzman ");
    ...
    private void initComponents() {
        ...
        jLabel1.setText("Marketing-Tin");

        jLabel2.setFont(new java.awt.Font("Tahoma", 0, 14)); // NOI18N
        jLabel2.setHorizontalAlignment(javax.swing.SwingConstants.CENTER);
        jLabel2.setText("Venta de productos Al alcance de tus manos");
        ...
        jLabel5.setIcon(new javax.swing.ImageIcon(getClass().getResource("/Img/EscudoUsta.png"))); // NOI18N
    ...
    void agregarProducto() {
        ...
        if (stock > 0) {
            ...
            JOptionPane.showMessageDialog(this, "Stock PRoducto no Disponible, espere la recarga de inventario");
        }
    }
